...
- Linter versions upgrades (N)
  ...
  - [clj-kondo](https://github.com/borkdude/clj-kondo) from 2025.01.16 to **2025.02.20** on 2025-02-21
  - [php-cs-fixer](https://cs.symfony.com/) from 3.68.6 to **3.69.1** on 2025-02-21
  - [phpstan](https://phpstan.org/) from 2.1.5 to **2.1.6** on 2025-02-21
  - [bandit](https://bandit.readthedocs.io/en/latest/) from 1.8.2 to **1.8.3** on 2025-02-21
  - [syft](https://github.com/anchore/syft) from 1.19.0 to **1.20.0** on 2025-02-21
  - [rubocop](https://rubocop.org/) from 1.71.2 to **1.72.2** on 2025-02-21
  - [scalafix](https://scalacenter.github.io/scalafix/) from 0.14.0 to **0.14.2** on 2025-02-21
<!-- linter-versions-end -->
